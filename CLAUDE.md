...
- **Colors** (dark/"ink" default — Anthropic-inspired warm palette): `--ink: #141413` (warm near-black), `--text: #F5F4EE` (Anthropic Light), `--cream: #EDE5CC`, `--live: #8FB5A6` (muted teal — functional accent only; lifted variant `--live-bright: #A0C7B7` for small dots)
